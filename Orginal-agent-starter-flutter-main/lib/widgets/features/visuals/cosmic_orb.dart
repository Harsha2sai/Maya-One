...
class _CosmicOrbState extends State<CosmicOrb> with TickerProviderStateMixin {
  ...
  String get _statusText {
    ...
    switch (widget.state) {
      case OrbState.listening:
        return 'LISTENING...';
      case OrbState.thinking:
        return 'PROCESSING...'; // React says PROCESSING
      case OrbState.speaking:
        return 'SPEAKING';
      case OrbState.idle:
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      onPanUpdate: widget.onPanUpdate != null ? (details) => widget.onPanUpdate!(details.delta) : null,
      child: Column(
                  ...
                  builder: (context, child) {
                    return Transform.scale(
                      ...
                      child: Transform.rotate(
                        angle: widget.state == OrbState.thinking ? _rotateController.value * 2 * pi : 0,
