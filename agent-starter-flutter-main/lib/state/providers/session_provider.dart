...
class SessionProvider extends BaseProvider {
  ...
  Future<bool> connect({String? userId, Map<String, dynamic>? clientConfig}) async {
    ...
    return await safeExecute(() async {
      ...
      bool isBackendUp = await _checkBackendHealth();
      ...
      final roomName = 'voice-assistant-${finalUserId.substring(0, math.min(finalUserId.length, 8))}-${DateTime.now().millisecondsSinceEpoch}';
