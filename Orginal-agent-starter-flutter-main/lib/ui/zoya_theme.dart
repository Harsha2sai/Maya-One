...
class ZoyaTheme {
  ...
  static const Color warning = Color(0xFFF59E0B);  // Amber – consistent with semantic conventions
  static const Color info = Color(0xFF3B82F6);     // Blue – used for running/in-progress state
