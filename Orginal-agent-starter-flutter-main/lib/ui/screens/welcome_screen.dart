...
import '../../widgets/common/cyber_notice.dart';
                    ...
                    children: [
                      ...
                      Consumer<SessionProvider>(
                        builder: (context, session, _) {
                          final isReady =
                              session.connectionState == SessionConnectionState.disconnected && !session.loading;
                      ...
                      Consumer<SessionProvider>(
                        builder: (context, session, _) {
                          return ZoyaButton(
                            ...
                            onPressed: session.isConnected ? () {} : () => _handleConnect(context),
                          );
                        },
                      ),
  ...
  Future<void> _handleConnect(BuildContext context) async {
    ...
    if (success && context.mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        CyberNoticeSnackBar.build(
          context,
          message: 'Connected successfully.',
          priority: CyberNoticePriority.success,
        ),
      );
    }
  }
