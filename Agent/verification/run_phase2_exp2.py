...
FAULT_SCRIPT = "sudo ./verification/faults/block_deepgram.sh"
RESTORE_SCRIPT = "sudo ./verification/faults/restore_deepgram.sh"
LOG_FILE = "chaos_phase2_reports/exp2_runner.log"
...
def main():
    log("🚀 Starting Experiment 2: STT Provider Failure (Deepgram)")
    ...
    if pid == 0:
        ...
        try:
            ...
            # In console mode, text input bypasses STT, but we verify the PROCESS doesn't crash 
            # due to background connection failures to Deepgram.
            os.write(master_fd, b"Can you hear me?\n")
            ...
            time.sleep(5) 
            os.write(master_fd, b"Are you back?\n")
