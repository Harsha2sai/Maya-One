...
Widget buildStatusBadge(bool isConfigured) {
  return Container(
    ...
    decoration: BoxDecoration(
      color: isConfigured ? ZoyaTheme.success.withValues(alpha: 0.1) : ZoyaTheme.danger.withValues(alpha: 0.1),
      borderRadius: BorderRadius.circular(4),
      border: Border.all(
          color: isConfigured ? ZoyaTheme.success.withValues(alpha: 0.3) : ZoyaTheme.danger.withValues(alpha: 0.3)),
    ),
    child: Row(
