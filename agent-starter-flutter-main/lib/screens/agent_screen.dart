    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(value, style: const TextStyle(color: ZoyaTheme.textMain, fontSize: 13, fontFamily: 'GeistMono')),
        ],
      ),
    );
  }
      ...
      children: List.generate(4, (index) {
        return AnimatedBuilder(
          ...
          builder: (context, child) {
            ...
            double activeGain = (vol * 5).clamp(0.0, 1.0);
            
            // Allow very subtle breathing when idle so it doesn't look broken
            double idleGain = 0.15;
            double effectiveGain = math.max(activeGain, idleGain);
    ...
    return MouseRegion(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: _hover ? ZoyaTheme.accent.withValues(alpha: 0.3) : Colors.white.withValues(alpha: 0.05)),
        ),
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            FaIcon(
              widget.icon, 
              color: _hover ? ZoyaTheme.accent : Colors.white70, 
              size: 16
            ),
            AnimatedSize(
              duration: const Duration(milliseconds: 300),
