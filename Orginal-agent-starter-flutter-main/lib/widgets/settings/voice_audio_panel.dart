...
class VoiceAudioPanel extends StatelessWidget {
    ...
    return Column(
      ...
      children: [
        ...
        _buildDropdown(
          ...
          (val) {
            if (val != null) onSttModelChanged(val);
          },
        ),
        const SizedBox(height: 24),
        _buildLanguageDropdown(
          ...
          (val) {
            if (val != null) onSttLanguageChanged(val);
          },
        ),
        ...
        _buildDropdown(
          ...
          (val) {
            if (val != null) onTtsVoiceChanged(val);
          },
        ),
      ],
    );
  ...
  Widget _buildProviderDropdown(String label, String value, List<Map<String, dynamic>> items,
      Map<String, dynamic> status, ValueChanged<String?> onChanged) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
                ...
                return DropdownMenuItem<String>(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      if (isConfigured) const Icon(Icons.check_circle, color: ZoyaTheme.success, size: 14),
                    ],
                  ),
                );
              }).toList(),
  ...
  Widget _buildLanguageDropdown(
      String label, String value, List<Map<String, String>> items, ValueChanged<String?> onChanged) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(label, style: const TextStyle(color: Colors.white70, fontSize: 12)),
