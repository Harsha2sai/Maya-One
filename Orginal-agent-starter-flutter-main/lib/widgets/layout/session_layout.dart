  ...
  Widget build(BuildContext context) {
    return MouseRegion(
      ...
      child: AnimatedContainer(
        ...
        height: 50,
        decoration: BoxDecoration(
          color: _isHovered ? ZoyaTheme.accent.withValues(alpha: 0.1) : const Color(0xFF000A14).withValues(alpha: 0.5),
          borderRadius: BorderRadius.circular(12),
          border: Border.all(
            color: _isHovered ? ZoyaTheme.accent : Colors.white.withValues(alpha: 0.1),
          ),
