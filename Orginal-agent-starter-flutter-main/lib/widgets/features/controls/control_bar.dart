        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              Flexible(
                  ...
                  child: components.MediaDeviceContextBuilder(
                    builder: (context, roomCtx, mediaDeviceCtx) => FloatingGlassButton(
                      ...
                      onTap: () {
                        mediaDeviceCtx.cameraOpened ? mediaDeviceCtx.disableCamera() : mediaDeviceCtx.enableCamera();
                      },
                    ),
                  )),
              const Flexible(
              ...
              Selector<WorkspaceController, bool>(
                selector: (ctx, workspace) => workspace.showTranscription,
                builder: (context, showTranscription, child) => Flexible(
                  ...
                  child: FloatingGlassButton(
                    ...
                    onTap: () => ctx.read<WorkspaceController>().toggleTranscription(),
                  ),
                ),
              ),
              Flexible(
