...
async def test_audio_state_degradation():
    ...
    mock_orch.session.say = AsyncMock()
    ...
    mock_orch.session.say.assert_awaited_with("I am having trouble hearing you. Reconnecting voice services...")
    
    # 2. Simulate Restoration
    mock_orch.session.say.reset_mock()
