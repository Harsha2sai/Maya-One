...
async def publish_agent_thinking(room: rtc.Room, turn_id: str, state: str):
    """
    Publish agent thinking state (thinking, searching, etc.)
    """
    await publish_chat_event(room, {
        "type": "agent_thinking",
        "turn_id": turn_id,
...
async def publish_tool_execution(room: rtc.Room, turn_id: str, tool_name: str, status: str):
    """
